...
namespace Anori.Extensions.UnitTests
{
    ...
    {
        [Test]
        public void EnumerableExtensions_ReferenceAtOrNull_null_ReturnNull()
        {
        ...
        [Test]
        public void EnumerableExtensions_ReferenceAtOrNull_in_Range_ReturnValue()
        {
        ...
        [Test]
        public void EnumerableExtensions_ReferenceAtOrNull_in_OutRange_ReturnNull()
        {
            IEnumerable<string> list = new List<string> { "0", "1", "2", "3" };
        ...
        [Test]
        public void EnumerableExtensions_ValueAtOrNull_null_ReturnNull()
        {
            Assert.Throws<ArgumentNullException>(
                () =>
                    {
